...
for energy in excitation_energies:
    ...
    for cm in cm_angles:
        ...
        pattern = os.path.join(base_path, f"final_sim_5000_{energy}mev_{cm}cm_*_*_*.root")
    ...
    output_array_dir = "/home2/user/u0100486/linux/doctorate/github/tracker_sim/final_analysis/"
